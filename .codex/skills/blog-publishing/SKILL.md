...
10. If the task requests a podcast manuscript or speaking outline, save it as Markdown under `podcasts/` at the repository root. Do not place podcast files anywhere under `data/`, and do not publish them on the website unless explicitly requested.
