...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang={siteMetadata.language} className="scroll-smooth" suppressHydrationWarning>
      ...
      <meta name="theme-color" media="(prefers-color-scheme: light)" content="#fffdf6" />
      <meta name="theme-color" media="(prefers-color-scheme: dark)" content="#121316" />
      <link rel="alternate" type="application/rss+xml" href={`${basePath}/feed.xml`} />
      <body className="bg-[var(--site-background)] pl-[calc(100vw-100%)] text-gray-950 antialiased dark:text-gray-50">
        <ThemeProviders>
